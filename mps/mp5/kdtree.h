...
class KDTree
{
  ...
  public:
    ...
    Point<Dim> quickSelect(vector<Point<Dim>>&, unsigned, unsigned, unsigned, unsigned);
    unsigned partition(vector<Point<Dim>>&, unsigned, unsigned, unsigned, unsigned);
    void build(vector<Point<Dim>>&, unsigned, unsigned, unsigned);
    void addToTree(KDTreeNode*&, KDTreeNode*&, unsigned);
    void remove (KDTreeNode*);
    Point<Dim> recurseNN(const Point<Dim>&, KDTreeNode*, unsigned, Point<Dim>&, bool&) const;
    double findDistance(const Point<Dim>&, const  Point<Dim>&) const;
  private:
